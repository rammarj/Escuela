...
namespace FilosofosComenzales
{
    class Mesa
    {
        ...
        public Mesa(int nFilosofos)
        {
            ...
            Sillas sillas = new Sillas(this.numeroFilosofos); //sillas que hay en la mesa (el numero de filosofos)
            ...
            {
                filosofos[i] = new Filosofo(i, palillos[i], palillos[(i + 1) % 5], sillas);
